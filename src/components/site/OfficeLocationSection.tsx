    ...
    <section className="py-20 px-6 bg-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* France Office */}
          <div className="bg-gray-900/50 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm flex flex-col">
            {/* France Map Background */}
            <div className="mb-8 relative">
              <div 
                className="w-32 h-40 bg-cover bg-center opacity-50"
                style={{ backgroundImage: 'url(/images/france.avif)' }}
              ></div>
            </div>

            <h3 className="text-2xl text-white mb-6">{t('office.france')}</h3>
          ...
          <div className="bg-gray-900/50 border border-gray-700 rounded-2xl p-8 backdrop-blur-sm flex flex-col">
            ...
            <div className="mb-8 relative">
              <div 
                className="w-32 h-40 bg-cover bg-center opacity-50"
                style={{ backgroundImage: 'url(/images/dubai.avif)' }}
              ></div>
            </div>

            <h3 className="text-2xl text-white mb-6">Dubai</h3>
          ...
          {/* Promotional Card */}
          <div className="bg-gray-200 rounded-2xl p-8 text-gray-800 flex flex-col justify-between">
            <div className="mb-8">
